...
int main(int argc, char **) {
    ...
    for (i = 0; i < REPEAT_COUNT; i++) {
        ...
        char cmd1[] = "tolower";
        sendto(socket_descriptor, cmd1, 7, 0, (struct sockaddr *) NULL, sizeof(address_descriptor));
        sendto(socket_descriptor, message_buffer, MESSAGE_LENGTH, 0, (struct sockaddr *) NULL, sizeof(address_descriptor));
        recvfrom(socket_descriptor, message_buffer, MESSAGE_LENGTH, 0, (struct sockaddr *) NULL, NULL);
        // cout << "Lower: " << message_buffer << endl;

        char cmd2[] = "toupper";
        sendto(socket_descriptor, cmd2, 7, 0, (struct sockaddr *) NULL, sizeof(address_descriptor));
        sendto(socket_descriptor, message_buffer, MESSAGE_LENGTH, 0, (struct sockaddr *) NULL, sizeof(address_descriptor));
        recvfrom(socket_descriptor, message_buffer, MESSAGE_LENGTH, 0, (struct sockaddr *) NULL, NULL);
